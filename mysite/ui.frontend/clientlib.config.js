...
module.exports = {
  ...
  libs: [
    ...
    },
    {
	  ...
	  categories: ['mysite.dynamic-modules'],
	  assets: {
		js: {
          cwd: 'clientlib-dynamic-modules',
          files: ['**/*.js'],
		  ignore: ['**/resources/*.js', '**/resources/*.css'],
          flatten: false
        },
		  resources: [
			"clientlib-dynamic-modules/resources/*.js",
			"clientlib-dynamic-modules/resources/*.css",
			"clientlib-dynamic-modules/resources/*.js,map"
		  ]
	  }
	}
  ]
